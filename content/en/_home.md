---
title: "Radu Herinean"
summary: "Radu Herinean, CTO at Cărturești. I write about the AI systems that made it into production, and what it takes to keep them there."
---
...
25 years ago I founded poezie.ro and agonia.net, the largest Romanian literary platforms — solo projects, from the idea to the architecture to the code. Both are still running, poezie.ro with volunteers from its community helping me run it, and rebuilding poezie.ro with AI agents taught me more about where these tools break than any work project has. This site is the archive — build logs, opportunity spotting, governance, and analysis, in English and Romanian. Advisory and project work goes through [Evolution Labs](https://evolution.ro); the quickest way to reach me is [LinkedIn](https://www.linkedin.com/in/herinean).
